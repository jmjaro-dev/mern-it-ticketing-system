...
const TicketHeader = ({ user, current, tickets, mapped, sorted, filtered, loading, getTickets,  sortTickets, clearCurrent }) => {
  useEffect(() => {
    if(current !== null) {
      clearCurrent();
    }
...
export default connect(mapStateToProps, { getTickets, sortTickets, clearCurrent })(TicketHeader);