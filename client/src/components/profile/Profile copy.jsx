    ...
    <div id="my-tickets" className="col s12 collection with-header">
      ...
      <div className="collection-item">
        <div className="center">
          {/* Open Tickets */}
          <span className="chip green-text text-darken-2" style={styles.ticket_label}> open 
          <span className="grey-text" style={styles.label}> ({ assigned ? assignedTickets.open : ownedTickets.open }) </span> 
          </span>
          {/* Pending Tickets */}
          <span className="chip orange-text text-darken-2" style={styles.ticket_label}> pending {' '} 
            <span className="grey-text" style={styles.label}>
              ({ assigned ? assignedTickets.pending : ownedTickets.pending })
            </span> 
          </span>
          {/* Closed Tickets */}
          <span className="chip grey-text text-darken-2" style={styles.ticket_label}> closed 
            <span className="grey-text" style={styles.label}> ({ assigned ? assignedTickets.closed : ownedTickets.closed }) </span>
          </span>
        </div>
        {/* tickets */}
          ...
          <tbody>
            {assigned && assigned.map(ticket => (
              <tr key={ticket._id}>
                ...
                <td>
                  <Link to={`/tickets/${ticket._id}`} className="ticket-details blue-text text-darken-2" onClick={onSetCurrent}>
